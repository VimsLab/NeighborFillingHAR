...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and acc > maxacc:
            checkpoint = {
            ...
            utils.save_on_master(
                checkpoint,
                os.path.join('outputs/', 'model_{}.pth'.format(epoch)))
            utils.save_on_master(
                checkpoint,
                os.path.join('outputs/', 'checkpoint.pth'))
            maxacc = acc
...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='outputs', type=str, help='path where to save')
    # resume
